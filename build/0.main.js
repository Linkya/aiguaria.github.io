...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checkout__ = __webpack_require__(411);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_settings_service__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_order_service__ = __webpack_require__(400);
...
var CheckoutPage = (function () {
    ...
    CheckoutPage.prototype.validHour = function (date) {
        ...
        this.openingTimes.forEach(function (openingTime) {
            if (date >= __WEBPACK_IMPORTED_MODULE_6_moment__(openingTime.open, 'HH:mm') && date <= __WEBPACK_IMPORTED_MODULE_6_moment__(openingTime.closed, 'HH:mm') && date >= now) {
                res = true;
            }
        });
        return res;
