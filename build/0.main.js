    ...
    SettingsService.prototype.getDistance = function (postalCode) {
        ...
        return new Promise(function (resolve, reject) {
            _this.getPath().then(function (data) {
                ...
                var qt = { lat: 41.1747295, lng: -8.5842759 };
                    ...
                    if (data) {
                        _this.settingsService.getOpeningTimes().then(function (data) {
                            if (data) {
                                ...
                                _this.loading.dismiss();
                                _this.alert("Atenção", "O estabelecimento encontra-se encerrado.");
                            }
                        }, function (error) {
                            _this.alert("Erro", "Verifique a sua ligação à rede e tente novamente.");
                            _this.loading.dismiss();
